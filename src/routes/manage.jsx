...
export const Manage = () => {
  return (
    <div className="w-full flex flex-col justify-start items-center gap-20 max-md:mt-15 max-md:p-10">
      ...
      <div className="flex flex-col justify-center items-center p-3 gap-5 bg-gray-100/75 border-solid border-[#191970]/25 border-1 rounded-2xl shadow-gray-400 shadow-lg">

        <div className="flex flex-row justify-center items-start gap-2">

          <div className="h-[200px] flex flex-col justify-start items-center gap-4 p-5 bg-gray-50 border-solid border-[#191970]/25 border-1 rounded-2xl shadow-gray-400 shadow-lg">
            ...
            <div className="flex flex-col justify-start items-center">
              ...
              <div className="flex flex-col justify-center items-center mt-3 gap-2">
                <p className="max-md:text-xs text-[#191970] font-semibold">
                  مهرداد کرمی
                </p>
