...
export const Home = () => {
  return (
    <div className="w-full flex flex-col justify-start items-center gap-20 max-md:mt-15 p-10">
      <section className="flex flex-col justify-center items-center gap-5 p-5 bg-gray-100/75 border-solid border-[#191970]/25 border-1 rounded-2xl shadow-gray-400 shadow-lg">
        <div className="flex flex-row justify-center p-2">
            <h2 className="max-md:text-sm text-[#191970] font-semibold">تعطیلی مدارس  چهارمحال و بختیاری یکشنبه  ۶ مهر ۱۴۰۴</h2>
        </div>
